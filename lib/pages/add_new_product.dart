...
class _AddNewProductState extends State<AddNewProduct> {
  ...
  Future<void> _submit() async {
    final isValid = _form.currentState
        .validate(); //JALANKAN VALIDASI, DIMANA FUNGSI INI TELAH DISEDIAKAN OLEH FORM WIDGET()
    //JIKA TIDAK VALID
    if (!isValid) {
      return; //MAKA HENTIKAN PROSES
    }
    _form.currentState
        .save(); //JIKA VALID MAKA FUNGSI SAVE() DIJALANKAN, DIMANA FUNGSI INI JUGA DARI FORM WIDGET
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed:
                _submit, //TOMBOL SIMPAN YANG KETIKA DITEKAN MAKA AKAN MENJALANKAN FUNGSI _submit YANG TELAH DIBUAT SEBELUMNYA
          )
        ],
      ),
      body: _isLoading
          ? Center(
              child:
                  CircularProgressIndicator(), //KETIKA ISLOADING BERNILAI TRUE MAKA INDIKATOR LOADING AKAN DIRENDER
            )
          : Padding(
              ...
              child: Form(
                key:
                    _form, //GLOBAL KEY YANG TELAH DIBUAT SEBELUMNYA DIGUNAKAN DISINI
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      controller:
                          _titleController, //ADAPUN VALUENYA TELAH DIHANDLE OLEH CONTROLLER MASING-MASING
                    ),
                    TextFormField(
